...
const AboutSectionContainer = styled.div`
  ${tw`flex flex-wrap items-center justify-center w-full pt-4 pb-4 pl-5 pr-5 bg-white md:pl-0 md:pr-0`};
`;
...
const InfoContainer = styled.div`
  ${tw`flex flex-col md:w-1/2 md:ml-2 2xl:ml-10`};
`;
